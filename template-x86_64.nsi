...
Section "Python dependencies" sec_deps
  ...
  ExecWait "$INSTDIR\x86\pysha3-0.3.win-amd64-py3.4.exe"
  ExecWait "$INSTDIR\x86\psutil-4.0.0.win-amd64-py3.4.exe"
  ExecWait "$INSTDIR\x86\pywin32-220.win-amd64-py3.4.exe"
...
Section "GRR Client" sec_grr
  ClearErrors
  ${LogText} "Installing GRR_3.0.0.7_amd64.exe"
  ExecWait "$EXEDIR\GRR_3.0.0.7_amd64.exe"

  IfErrors 0 noerror
    ${LogText} "Error installing GRR_3.0.0.7_amd64.exe"
  noerror:
SectionEnd
